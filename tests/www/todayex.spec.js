...
test('Verify job title with valid credentials2', async ({ page }) => {
  ...
  await page.getByRole('textbox').nth(1).fill(addjobtitle.jobtitle);
  ...
  //assertion
 // await page.locator('.oxd-toast-container').toBeVisible();
  //await expect(page).toHaveURL('https://opensource-demo.orangehrmlive.com/web/index.php/admin/viewJobTitleList');
  //await page.waitForURL('https://opensource-demo.orangehrmlive.com/web/index.php/admin/viewJobTitleList');
  ...
  await expect(page.getByRole('columnheader', { name: 'Job Titles ' })).toBeVisible();
});
